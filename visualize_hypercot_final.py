...
def visualize_hypercot(save_path=None):
    ...
    # Plot the sorted coupling matrix with transparency for low values
    pi_plot = pi_sorted.copy()
    pi_plot[pi_plot < 1e-6] = np.nan  # Make near-zero values transparent
    im_pi = ax_pi.imshow(pi_plot, aspect='auto', cmap='Reds', zorder=1)
